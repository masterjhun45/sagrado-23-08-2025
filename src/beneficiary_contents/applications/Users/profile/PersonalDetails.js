              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    value={formData.system_generated_rsbsa_number}
                    onChange={(e) => updateField('system_generated_rsbsa_number', e.target.value)}
                    disabled={!isEditing}
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    value={formData.manual_rsbsa_number}
                    onChange={(e) => updateField('manual_rsbsa_number', e.target.value)}
                    disabled={!isEditing}
                    variant={isEditing ? "outlined" : "filled"}
                    InputProps={{ readOnly: !isEditing }}
                  />
